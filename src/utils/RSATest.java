...
public class RSATest {
	...
	public static void main(String args[]) throws Exception {
		...
		/*
		 * Save on database sealedbid + publickey
		 * 
		 * 
		 * After auction terminates (finishes)
		 *  - Un seal all the bids using decryptOne method.
		 *  
		 *  - Publish auction report that consists of Username, Bid, Signature, publicKey
		 * */

String encryptedString = "";
		System.out.println("Unsealed bid: "+ decryptOne(encryptedString));
		String unseal = Arrays.toString(decryptOne(encryptedString).split("/"));
