    			 ...
    			 $.ajax({
               		...
               		success:function(data){
    					var status=0;
               			...
               			$('#modaltable tr').eq(0).after('<tr><td>'+bb.pname+'</td><td>'+bb.bidno+'</td><td>'+bb.sigval+'</td><td>'+bb.date+'</td><td>'+bb.time+'</td><td><a href=show.jsp?id='+bb.id+'>View Results</a></td></tr>');						  
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Your Bids & Wishlist</h3>
