...
<% String s=(String)session.getAttribute("uname");%>
         ...
         $(document).ready(function(){
                       ...
                       $.ajax({
                     	type:"POST",
                  		...
                  		data:{
                				...
                				pName:name,
                				pCategory:category,
                				pAuctiontype:auctiontype,
                				pReserve:reserveprice,
             ...
             $('#reserveprice').change(function(event) {
            	 var func = "searching";
         		var name = $("#search").val();
         		var category = $("#category").val();
         		var auctiontype = $("#auctiontype").val();
             ...
             $('#closingdate').change(function(event) {
            	 var func = "searching";
         		var name = $("#search").val();
         		var category = $("#category").val();
         		var auctiontype = $("#auctiontype").val();
                       ...
                       $.ajax({
                     	type:"POST",
                  		...
                  		success:function(data){
        					...
        					if(distances<0){
                       			$('#showimg').after('<div  class="col-lg-4 col-md-4 col-sm-4 mb"><div id="start" class="content-panel pn" id="start" style="height:300px;"><div id="blog-bg"><div class="badge badge-popular">'+bb.price+'$</div><div class="blog-title">'+bb.name+'</div><img src="data:image/png;base64,' + bb.image + '" width="365" alt=""></div><br><div class="blog-text"><p>'+bb.description+'</p> <p>Closed</p></div></div></div>');						  
                   			status=status+1;
                     	    }
                   			  }
                   			
                   			  if(status==0){			  
        				  $('#showimg').after('<div  class="col-lg-4 col-md-4 col-sm-4 mb"><div id="start"  class="content-panel pn" id="start" style="height:400px;"><div id="blog-bg"><div class="badge badge-popular">'+bb.price+'$</div><div class="blog-title">'+bb.name+'</div><img src="data:image/png;base64,' + bb.image + '" width="365" alt=""></div><br><div class="blog-text"><p>'+bb.description+'</p> <p>Open in:'+days+' d '+hours+' h '+minutes+' m '+minutes+' s  <a href="showAuction.jsp?id='+bb.id+'">&nbsp&nbspFuther Detail</a></p><a class="btn btn-sm btn-clear-g"  href=welcome.jsp?id='+bb.id+'><img src="assets/like.png" style="width:20px;height:20px"></a></div></div></div>');						  
                   }
                   			}
                      ...
                      $.ajax({
                    	type:"POST",
                 		...
                 		success:function(data){
        					...
        					if(distances<0){
                       			$('#showimg').after('<div  class="col-lg-4 col-md-4 col-sm-4 mb"><div id="start1" class="content-panel pn" style="height:300px;"><div id="blog-bg"><div class="badge badge-popular">'+bb.price+'$</div><div class="blog-title">'+bb.name+'</div><img src="data:image/png;base64,' + bb.image + '" width="365" alt=""></div><br><div class="blog-text"><p>'+bb.description+'</p> <p>Closed</p></div></div></div>');						  
                   			status=status+1;
                     	    }
                   			  }
                   			
                   			  if(status==0){			  
        				  $('#showimg').after('<div  class="col-lg-4 col-md-4 col-sm-4 mb"><div id="start2" class="content-panel pn" style="height:300px;"><div id="blog-bg"><div class="badge badge-popular">'+bb.price+'$</div><div class="blog-title">'+bb.name+'</div><img src="data:image/png;base64,' + bb.image + '" width="365" alt=""></div><br><div class="blog-text"><p>'+bb.description+'</p> <p>Open in:'+days+' d '+hours+' h '+minutes+' m '+minutes+' s  <a href="showAuction.jsp?id='+bb.id+'">&nbsp&nbspFuther Detail</a></p><a class="btn btn-sm btn-clear-g"  href=welcome.jsp?id='+bb.id+'><img src="assets/like.png" style="width:20px;height:20px"></a></div></div></div>');						  
                   }
                   			}
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3 id="bg"><i class="fa fa-angle-right"></i> Browse</h3>
          	      </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
...
<input type="name" id="search" Placeholder="Search">
 Category<select id="category" name="category">
             ...
             Auction Type<select id="auctiontype" name="auctiontype">
                             <option>---------</option>
                             <option>English Auction</option>
                             <option>Blind Auction</option>
                             </select>
             Reserve Price<select id="reserveprice" name="reserveprice">
                             <option>---------</option>
                             <option>Reserve Price</option>
                             <option>No Reserve Price</option>
                             </select>
             Closing date<select id="closingdate" name="closingdate">
                             <option>---------</option>
                             <option>Today</option>
